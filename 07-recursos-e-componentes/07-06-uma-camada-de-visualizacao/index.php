...
$plates = new League\Plates\Engine(__DIR__ . "/../assets/views/teste", "php");
var_dump(get_class_methods($plates));

//$plates->addFolder("teste",  __DIR__ . "/../assets/views/teste");
//
//if (empty($_GET["id"])) {
//    echo $plates->render("teste::list", [
//        "title" => "Usuários do sistema",
//        "list" => (new \Source\Models\User())->all(5)
//    ]);
//} else {
//    echo $plates->render("teste::user", [
...
$view->path("teste",  __DIR__ . "/../assets/views/teste");

if (empty($_GET["id"])) {
    echo $view->render("teste::list", [
        "title" => "Usuários do sistema",
        "list" => (new \Source\Models\User())->all(5)
    ]);
} else {
    echo $view->render("teste::user", [
        "title" => "Editar usuário",
        "user" => (new \Source\Models\User())->findById($_GET["id"])
    ]);
}
