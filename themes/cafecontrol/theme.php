...
<head>
    <meta charset="UTF-8">
        <meta name="mit" content="2023-07-18T21:08:28-03:00+199293">
    ...
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item social">
                ...
                <a target="_blank" class="icon-instagram" href="https://www.instagram.com/<?= CONF_SOCIAL_FACEBOOK_PAGE ?>" title="CafeControl no Instagram">@CafeControl</a>
                <a target="_blank" class="icon-youtube" href="https://www.youtube.com/<?= CONF_SOCIAL_FACEBOOK_PAGE ?>" title="CafeControl no YouTube">/CafeControl</a>
            </article>
        </section>
    </div>
</footer>
